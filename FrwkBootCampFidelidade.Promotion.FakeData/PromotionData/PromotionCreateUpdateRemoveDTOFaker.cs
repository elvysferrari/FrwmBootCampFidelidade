...
{
    public class PromotionCreateUpdateRemoveDTOFaker : Faker<PromotionCreateUpdateRemoveDTO>
    {
        public PromotionCreateUpdateRemoveDTOFaker()
        {
            ...
            RuleFor(x => x.PromotionItems, f => new PromotionItemCreateUpdateRemoveDTOFaker().Generate(3));
        }
    }
}
