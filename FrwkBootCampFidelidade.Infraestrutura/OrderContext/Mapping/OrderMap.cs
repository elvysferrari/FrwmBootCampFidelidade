...
namespace FrwkBootCampFidelidade.Infraestrutura.OrderItemContext.Mapping
{
    public class OrderMap : IEntityTypeConfiguration<Order>
    {
        ...
        private ICollection<Order> ObterDados()
        {
            ...
            return new[]{
                new Order() { Cpf = "02563215479", StoreId = 1, TotalValue = 658.96f, CreatedAt = createdAt, UpdatedAt = createdAt, UserId = 1 },
                new Order() { Cpf = "65989847894", StoreId = 1, TotalValue = 1698.66f, CreatedAt = createdAt, UpdatedAt = createdAt, UserId = 1 },
            };
        }
