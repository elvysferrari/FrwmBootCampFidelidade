            ...
            using (var scope = _serviceProvider.CreateScope())
            {
                ...
                switch (message.Method)
                {
                    ...
                    case MethodConstant.GETBYID:
                        response = promotionService.GetById(JsonConvert.DeserializeObject<string>(message.Content));
                        break;
                    ...
                    case MethodConstant.REMOVEBYID:
                        response = promotionService.RemoveById(JsonConvert.DeserializeObject<string>(message.Content));
                        break;
